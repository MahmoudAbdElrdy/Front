...
@Component({
  selector: 'app-EM-navigation',
  templateUrl: './EM-navigation.component.html',
  styleUrls: ['./EM-navigation.component.css']
})
export class EMNavigationComponent  implements AfterViewInit {
