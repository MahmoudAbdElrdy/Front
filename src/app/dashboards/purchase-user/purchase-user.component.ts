...
@Component({
  selector: 'app-purchase-user',
  templateUrl: './purchase-user.component.html',
  styleUrls: ['./purchase-user.component.css']
})
export class PurchaseUserComponent implements OnInit {
  ...
  GatAll(pageindex = 1, pageSize = 5){
    ...
    this.PurchasesService.apiPurchasesGetPurchasesByUserIdGet$Json({pageNumber:pageindex,pageSize:pageSize,ApplicationUserId:Id}).subscribe
    (
      (res) => {
